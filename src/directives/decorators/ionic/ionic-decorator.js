angular.module('schemaForm').config(['schemaFormDecoratorsProvider', function(decoratorsProvider) {
  var base = 'bower_components/angular-schema-form/src/directives/decorators/ionic/';
  ...
  return {
    transclude: true,
    scope: true,
    templateUrl: 'bower_components/angular-schema-form/src/directives/decorators/bootstrap/fieldset-trcl.html',
